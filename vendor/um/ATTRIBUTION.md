...
- 文件：
  - `loader.mjs` —— wasm-bindgen 生成的 ES Module 胶水（由 `js/app.js` 动态 import）
  - `um_wasm_bg.wasm` —— 解密核心（NCM / QMC1 / QMC2(mflac,mgg) / 酷狗 KGM,KGMA,VPR / 酷我 KWM / 虾米 / 喜马拉雅 / 歌词 QRC / 音频类型嗅探）
