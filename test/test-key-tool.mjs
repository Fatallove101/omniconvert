...
import { SONG_TOOL_EXTS, KEY_TOOL_EXTS, KEY_HINTS } from './check-music.mjs';
...
check(
  '「密钥格式转换」接受的扩展名 = 体检脚本的 KEY_TOOL_EXTS',
  JSON.stringify(extsOf(keyTool)) === JSON.stringify([...KEY_TOOL_EXTS].sort()),
